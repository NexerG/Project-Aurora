...
{
    internal unsafe class RendererBaseClass
    {
        internal static RendererBaseClass _rendererInstance = null;
        ...
        internal void InitRenderer(bool RTX)
        {
            ...
            if (!RTX) { VulkanRenderer _rasterizer = new VulkanRenderer(); }
            else { Pathtracing _pt = new Pathtracing(); }
        }
