...
| [[ecs-rework-data-pools]] | **PARTIAL** — OO components become pooled columns; handles, compaction; command lanes (deleted 2026-09-23) | `DataPool`, `DataManager`, `PoolColumn`, `TransformData` |
