...
- [x] **UI Engine landing 6a — the base gap (2026-09-06)** — landed, See `ClaudeMemory/Decisions/ui-engine-stack.md`
	- [ ] **landings 6b–6d: 6b is across (6b3, 2026-09-12) and a note draws on the new stack (6c-a, 2026-09-12)** — chrome, containers, tabs, files, menus, the settings interactables, the drag ghost; then the document stack, where a run is a `StyleSpan` and a block is one control. Left: 6c-b editing and undo, 6c-c the format bar, deleting `NextProbe.ui.xml`, 6c2 the secondary windows, hosts, tear-off and `SessionLayout` (moved to the end, user 2026-09-11), then 6d the delete. Per-landing detail in `ClaudeMemory/Context/ui-engine-plan.md`
