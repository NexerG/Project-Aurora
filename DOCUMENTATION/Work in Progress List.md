...
- [ ] **frame scheduler — every system a step of one graph, every core used (plan agreed 2026-09-23).** Steps 1–2 landed (graph, access check, `Threads`/`MaxFps`; Main as 5 steps, edge steps, lanes deleted, animation writes in place); next: step 3 `Jobs.For`, then step 4 SIMD tracks. See `ClaudeMemory/Context/frame-scheduler-plan.md`
