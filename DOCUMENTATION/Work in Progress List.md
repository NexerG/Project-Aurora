...
- [x] **UI Engine landing 6a — the base gap (2026-09-06)** — landed, See `ClaudeMemory/Decisions/ui-engine-stack.md`
	- [ ] **landings 6b–6d: 6b and the whole document stack are across (6c, 2026-09-12)** — chrome, containers, tabs, files, menus and the drag ghost, then notes, where a run is a `StyleSpan` and a block is one control. Left: deleting `NextProbe.ui.xml`, 6c2 the windows, hosts, tear-off and `SessionLayout`, then 6d the delete → `ui-engine-plan`
