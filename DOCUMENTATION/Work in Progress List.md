...
- [x] **UI Engine landing 6a — the base gap (2026-09-06)** — landed, See `ClaudeMemory/Decisions/ui-engine-stack.md`
	- [ ] **landings 6b–6d: 6b, 6c and 6c2 are built (2026-09-13)** — Carbon boots on the new stack alone (GUI-verified); Thorium's windows, tear-off and `SessionLayout` are across. Left: by-hand checks of the name and confirm prompts and tear-off, then 6d the delete, which also breaks the Editor's old-stack boot → `ui-engine-plan` § 6c2
