...
namespace ArctisAurora.Core.UI
{
    ...
    // between them, the same shape as NextNoteNameWindow.
    public static class NextConfirmWindow
    {
        private const string windowName = "next-confirm";
        ...
        private static NextLabelControl _message = null!;
        ...
        private static NextButtonControl Button(string caption, Action action)
        {
