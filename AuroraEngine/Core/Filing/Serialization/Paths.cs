...
namespace ArctisAurora.Core.Filing.Serialization
{
    public static class Paths
    {
        ...
        public static readonly string FRAME = Doc("Frame.frame.xml");
        ...
        private static bool Mount()
        {
            ...
            // ('AuroraEngine', a sibling of each application). Mount it at lower priority so
            ...
            if (Engine.isDebug)
            {
                string engineData = Path.GetFullPath(Path.Combine(primary, "..", "..", "AuroraEngine", "Data"));
